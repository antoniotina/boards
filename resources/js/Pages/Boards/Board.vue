<template>
    <div class="h-full">
        ...
        <div class="h-full overflow-x-auto flex flex-nowrap">
            <div v-for="column in columns" :key="column.id" class="h-5/6 bg-gray px-4 mx-2 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md" style="min-width: 300px;">
                <h3>{{ column.name }}</h3>
